...
p <- ggplot(comm_df) + 
  ...
  annotate("text", x = 15, y = 126, label = "italic(Bolboschoenus~maritimus)", parse = TRUE, size = 4) +
  annotate("text", x = 15, y = 80, label = "italic(Phalaris~coerulescenss)", parse = TRUE, size = 4) +
  theme_classic()+
